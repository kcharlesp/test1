...
import (
	...
	params "github.com/classic-terra/core/v2/app/params"
...
func SetupApp(t *testing.T) *app.TerraApp {
	...
	balance := banktypes.Balance{
		...
		Coins:   sdk.NewCoins(sdk.NewCoin(params.BondDenom, sdk.NewInt(100000000000000))),
	}
...
func setup(withGenesis bool, invCheckPeriod uint) (*app.TerraApp, app.GenesisState) {
	...
	terraapp := app.NewTerraApp(
		...
		wasmconfig.GetConfig(simapp.EmptyAppOptions{}),
	)
	if withGenesis {
